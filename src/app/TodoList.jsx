...
const TodoList = (props) => {
    ...
    return (
        <div className='Todo mt-3'>
            ...
            <label className="flex items-center h-10 px-2 rounded text-base" htmlFor="task_8">

                {/* final text will appear */}

                <span className="ml-2 text-base">{props.text}</span>

                {/* delete task */}
                <span onClick={() => { props.onSelect(props.id) }} className="flex border-2 fa-trash cursor-pointer rounded-full">
                    {/* <button title='Delete Task' className='container'> */}
